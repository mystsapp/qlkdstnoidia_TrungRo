...
{
    public class BCDTPhongKDKDController : BaseController
    {
        ...
        public ActionResult dtphongkdkd(string tuthang1, string denthang1, string nam1, string tuthang2, string denthang2, string nam2, string dlcn)
        {
        ...
        //public ActionResult dtphongkdkd(string tungay, string denngay, string tungay1, string denngay1)
        //{
        //    var dao = new baocaoDAO();
        //    DateTime d1 = DateTime.Parse(DateTime.Now.AddDays(-365).ToString("yyyy") + "-1-1");
        //    DateTime d2 = DateTime.Parse(DateTime.Now.AddDays(-365).ToString("yyyy") + "-12-31");
