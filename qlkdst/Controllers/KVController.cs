...
{
    public class KVController : BaseController
    {
        ...
        public ActionResult Create(khuvuc model)
        {
        ...
        [ValidateInput(true)]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(khuvuc model)
        {
            var session = Session["username"];
