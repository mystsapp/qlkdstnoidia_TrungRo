...
{
    public class CacNNController : BaseController
    {
        ...
        {
            cacnoidunghuytour model = new cacnoidunghuytour();
        ...
        public ActionResult Create(cacnoidunghuytour model)
        {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var dao = new NguyenNhanDAO();
            cacnoidunghuytour model = dao.Details(id);
            if (model == null)
            {
                return HttpNotFound();
            }
        ...
        [ValidateInput(true)]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(cacnoidunghuytour model)
        {
            var session = Session["username"];
