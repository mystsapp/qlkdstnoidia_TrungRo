...
{
    public class pkcnController : BaseController
    {
        ...
        public ActionResult Create(phankhucn model)
        {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var dao = new phankhucnDAO();
            phankhucn model = dao.Details(id);
            if (model == null)
            {
                return HttpNotFound();
            }
        ...
        [ValidateInput(true)]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(phankhucn model)
        {
            var session = Session["username"];
