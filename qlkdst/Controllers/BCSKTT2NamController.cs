...
{
    public class BCSKTT2NamController : BaseController
    {
        // GET: BCSKTT2Nam
        ...
        public ActionResult dtsktt2nam(string tuthang1, string denthang1, string nam1, string tuthang2, string denthang2, string nam2, string dlcn)
        {
            ...
            dt = dao.BCSKTheoTuyen2Nam(d1, d2, d3, d4, Session["username"].ToString(), sRoles, dlcn,sCongTyPre);


            return View(dt);
        }

        //public ActionResult dtsktt2nam(string tungay, string denngay, string tungay1, string denngay1)
        //{
        //    var dao = new baocaoDAO();
        //    DateTime d1 = DateTime.Parse(DateTime.Now.AddDays(-365).ToString("yyyy") + "-1-1");
        //    DateTime d2 = DateTime.Parse(DateTime.Now.AddDays(-365).ToString("yyyy") + "-12-31");
        ...
        //    dt = dao.BCSKTheoTuyen2Nam(d1, d2, d3, d4, sUserName, sRoles, sChinhanh);
        ...
        public ActionResult Excel(string tuthang1, string denthang1, string nam1, string tuthang2, string denthang2, string nam2, string schinhanh)
        {
            ...
            string Filename = "BCSosanhskcacnam_" + System.DateTime.Now.ToString("dd_MM_yyyy_hh_mm_ss") + ".xlsx";
        ...
        private DataSet GetDuLieuBC(DateTime d1, DateTime d2, DateTime d3, DateTime d4,string schinhanh)
        {
            ...
            DataSet ds = dao.BCSKTheoTuyen2Nam(d1, d2, d3, d4, Session["username"].ToString(), sRoles, schinhanh,sCongTyPre);
        ...
        private Stream CreateExcel(string tuthang1, string denthang1, string nam1, string tuthang2, string denthang2, string nam2,string schinhanh, Stream stream = null)
        {
            ...
            using (var excelPackage = new ExcelPackage(stream ?? new MemoryStream()))
            {
                ...
                excelPackage.Workbook.Properties.Title = "SO SÁNH SỐ KHÁCH  THEO TUYẾN " + sNam1 + " & " + sNam2;
        ...
        //        sNam1 = d1.ToString("yyyy");
        //        sNam2 = d3.ToString("yyyy");
        //        excelPackage.Workbook.Properties.Title = "SỐ KHÁCH KHÁCH ĐOÀN SO SÁNH " + sNam1 + " & " + sNam2;
        ...
        public ExcelWorksheet FormatWorkSheet(DataSet ds, ExcelWorksheet ew, DateTime d1, DateTime d2)
        {
            ...
            string sReportTitle = "SO SÁNH SỐ KHÁCH THEO TUYẾN " + sNam1 + " & " + sNam2;
            ...
            ewres.Cells[4, 3].LoadFromText("Số khách năm " + sNam2);
            ewres.Cells[4, 4].LoadFromText("Số khách năm " + sNam1);
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                //var chart = ewres.Drawings.AddChart("lineChart", eChartType.BarClustered);
                //chart.Title.Text = sReportTitle;
                //chart.SetPosition(2, 0, 6, 0);
                //chart.SetSize(600,940 );
                ...
                foreach (DataRow row in distinctTuyen.Rows)
                {
                    ...
                    ewres.Cells[iRowIndex, 4].Value = dSK2;
